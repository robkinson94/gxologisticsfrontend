    ...
    <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-r from-[#1C1C1C] to-[#2E3033]">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <form onSubmit={handleLogin} className="mt-6">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 text-white bg-[#ff3a00] rounded-lg shadow-md hover:bg-indigo-700 transition duration-300 flex items-center justify-center"
            ...
            {loading ? (
              ...
              >
                <path
                  ...
                  fill="currentColor" // Corrected from "currentFill"
                />
                <path
        ...
        <p className="mt-6 text-center text-gray-600">
          <Link
            to="/register"
            className="block py-2 hover:text-blue-600 rounded" // Fixed typo: 'hover:color-blue-600' to 'hover:text-blue-600'
          >
